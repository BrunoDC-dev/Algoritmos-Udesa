...
bool test_array_max() {
  ...
  array[3] = 20;
  tests_result &=
      test_assert("Prueba máximo de arreglo", array_max(array, 5) == 20);

  for (int i = 0; i < 5; i++) {
    array[i] = 10 - i;
  }
  tests_result &= test_assert("Prueba máximo de arreglo al principio",
                              array_max(array, 5) == 10);

  for (int i = 0; i < 5; i++) {
    array[i] = i;
  }
  tests_result &= test_assert("Prueba máximo de arreglo al final",
                              array_max(array, 5) == 4);
  ...
  array[2] = 20;
  array[3] = 20;
  tests_result &= test_assert("Prueba máximo de arreglo dos veces",
                              array_max(array, 5) == 20);

  tests_result &= test_assert("Prueba máximo de arreglo de un elemento",
                              array_max(&elem, 1) == 10);
  return tests_result;
}
...
bool test_array_of_array_copy() {
  ...
  int **copy = copy_array_of_arrays((const int **)array_of_arrays,
                                    array_lengths, array_amount);
  for (int i = 0; i < array_amount; i++) {
    for (int j = 0; j < array_lengths[i]; j++) {
  ...
  copy = copy_array_of_arrays((const int **)array_of_arrays, array_lengths,
                              array_amount);
...
bool test_array_equal() {
  ...
  tests_result &= test_assert("Prueba igualdad de arreglos largo distinto",
                              !array_equal(array1, 2, array2, 3));
  tests_result &= test_assert("Prueba igualdad de arreglos iguales",
                              array_equal(array1, 5, array2, 5));
  tests_result &= test_assert("Prueba igualdad de arreglos ambos nulos",
                              array_equal(NULL, 5, NULL, 5));
  tests_result &= test_assert("Prueba igualdad de arreglos uno nulo",
                              !array_equal(array1, 5, NULL, 5));
  tests_result &= test_assert("Prueba igualdad de arreglos el otro nulo",
                              !array_equal(NULL, 5, array2, 5));
  array1[3] = 7;
  tests_result &=
...
bool test_integer_anagrams() {
  ...
  tests_result &= test_assert("Prueba anagramas de arreglos largo distinto",
                              !integer_anagrams(array1, 2, array2, 3));
  tests_result &= test_assert("Prueba anagramas de arreglos iguales",
                              integer_anagrams(array1, 10, array2, 10));
  tests_result &= test_assert("Prueba anagramas de arreglos ambos nulos",
                              !integer_anagrams(NULL, 5, NULL, 5));
  tests_result &= test_assert("Prueba anagramas de arreglos uno nulo",
                              !integer_anagrams(array1, 5, NULL, 5));
  tests_result &= test_assert("Prueba anagramas de arreglos el otro nulo",
                              !integer_anagrams(NULL, 5, array2, 5));
  for (int i = 0; i < 10; i++) {
    array2[i] = 9 - i;
  }
  ...
  tests_result &= test_assert("Prueba anagramas con swap",
                              integer_anagrams(array1, 10, array2, 10));
  array2[4] = 1;
  tests_result &=
